     ...
     <div className="px-3 w-full flex flex-col overflow-hidden text-ellipsis">
      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center" >
          ...
          <label className="text-sm text-zinc-500">2.3k</label>
        </div>
        <div className="flex items-center" >
          <Button className="p-1 text-zinc-500 dark:text-zinc-200" icon={<Eye size={22} />} />
          <label className="text-sm text-zinc-500">10.2k</label>
        </div>
        <div className="flex items-center" >
          <Button className="p-1 text-zinc-500 dark:text-zinc-200" icon={<MessageSquare size={22} />} />
          <label className="text-sm text-zinc-500">128</label>
        </div>
      </div> 
      </div>
   </div>
