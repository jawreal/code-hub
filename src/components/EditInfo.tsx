...
const EditInfo = ({ closeModal }: PropsType) => {
  return (
    <div className="w-full flex flex-col gap-y-2 px-2">
      <div className="flex gap-x-2 justify-start items-start dark:border-zinc-800 pt-2 mb-3">
        <span className="p-2 rounded-md dark:bg-emerald-600 bg-emerald-500 text-emerald-50">
          <PencilLine size={28}/>
        </span> 
        <div className="flex flex-col w-full items-start">
           <span className="text-xl font-bold dark:text-zinc-200"> Edit Profile</span>
      ...
      <div className="w-full flex items-center pt-3 dark:border-zinc-800">
