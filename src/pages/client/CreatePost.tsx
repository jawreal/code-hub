...
import { Plus, HelpCircle, Trophy, Check  } from 'lucide-react';
      ...
      <main className="w-full order-2 h-full pb-8 px-3 md:px-2 md:max-w-[40rem]">
        <form className="bg-inherit w-full p-2 rounded-md flex flex-col items-center p-3">
         <div className="w-full grid grid-cols-2 gap-x-2 mb-3">
           ...
           <Button className={`transition-all duration-300 rounded-md border ${postData.post_type === "question" ? "border-l-8 border-emerald-500 dark:text-zinc-200" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"} w-full py-3 px-4 h-36 md:h-auto flex flex-col justify-center relative`} onClick={questionPost}>
           ...
           <Button className={`transition-all duration-300 ease-in-out rounded-md border ${postData.post_type === "challenge" ? "border-l-8 border-emerald-500 dark:text-zinc-200" : "border-zinc-200 dark:border-zinc-800 text-zinc-500"} w-full py-3 px-4 h-36 md:h-auto flex flex-col justify-center`} onClick={challengePost}>
             <div className="w-full flex flex-col md:flex-row items-center gap-y-1 md:gap-x-2">
         ...
         <div className="flex flex-col w-full space-y-2 md:space-y-4">
          ...
          <div className="w-full flex flex-col mt-2">
             ...
             <Button className="rounded-md border border-zinc-200 dark:border-zinc-800 py-1 px-2 bg-zinc-100 dark:bg-zinc-900 dark:text-zinc-200 flex space-x-2 items-center self-start text-zinc-500 text-sm gap-x-1">
                 Add tags
                <Plus size={18} /></Button>
           </div> 
           <div className="flex flex-col w-full"> 
