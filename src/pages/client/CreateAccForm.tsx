...
const CreateAcc = () => {
  return (
      <form name="sign-up" className="flex flex-col md:ml-auto md:mr-10 gap-y-3 w-72 md:w-80 text-center z-10">
           ...
           <div className="w-full flex flex-col gap-x-2 justify-center items-center">
              ...
              <div className="w-full flex flex-row justify-center gap-x-2">
                 <Button className="dark:bg-zinc-900 bg-gray-100 rounded-md py-3 w-py-3 flex-1 flex justify-center px-6 font-medium border border-zinc-300 dark:border-zinc-800 active:bg-zinc-300/30 active:dark:bg-zinc-950/30" icon={<GoogleLogo />}/>
                 <Button className="dark:bg-zinc-900 bg-gray-100 rounded-md py-3 flex-1 flex justify-center px-6 font-medium border border-zinc-300 dark:border-zinc-800 active:bg-zinc-300/30 active:dark:bg-zinc-950/30" icon={<GitHubLogo />}/>
              </div>
           </div>
      </form>
    )
