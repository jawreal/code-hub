...
const CreateAcc = () => {
  return (
      <form className="flex flex-col md:ml-auto md:mr-10 gap-y-3 w-72 md:w-80 text-center z-10">
           <label className="text-xl font-medium dark:text-slate-200">Sign Up & Connect!</label>
           ...
           <div className="w-full flex flex-col gap-x-2 justify-center items-center">
              <Button className="bg-emerald-600 dark:bg-emerald-400/25 dark:border dark:border-emerald-50/20 rounded-md py-2 px-4 text-emerald-50 font-medium w-24" text="Sign Up" />
              <label className="text-zinc-500 my-4">or continue with</label>
